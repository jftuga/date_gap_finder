...
func TestSearch1(t *testing.T) {
	...
	iss.Equal(missingDates[0].ToTime().String(), "2021-04-17 06:55:01 +0000 UTC")
	iss.Equal(missingDates[1].ToTime().String(), "2021-04-18 06:55:01 +0000 UTC")
...
func TestSearch2(t *testing.T) {
	...
	iss.Equal(missingDates[0].ToTime().String(), "2021-04-15 00:00:00 +0000 UTC")
	iss.Equal(missingDates[1].ToTime().String(), "2021-04-16 00:00:00 +0000 UTC")
	iss.Equal(missingDates[2].ToTime().String(), "2021-04-17 00:00:00 +0000 UTC")
	iss.Equal(missingDates[3].ToTime().String(), "2021-04-18 00:00:00 +0000 UTC")
...
func TestSearch3(t *testing.T) {
	...
	iss.Equal(missingDates[0].ToTime().String(), "2021-03-12 18:40:01 +0000 UTC")
	iss.Equal(missingDates[1].ToTime().String(), "2021-03-13 18:40:01 +0000 UTC")
	iss.Equal(missingDates[2].ToTime().String(), "2021-03-14 18:40:01 +0000 UTC")
	iss.Equal(missingDates[3].ToTime().String(), "2021-03-17 18:40:01 +0000 UTC")
	iss.Equal(missingDates[4].ToTime().String(), "2021-03-18 18:40:01 +0000 UTC")
	...
	iss.Equal(missingDates[0].ToTime().String(), "2021-03-12 18:40:01 +0000 UTC")
	iss.Equal(missingDates[1].ToTime().String(), "2021-03-17 18:40:01 +0000 UTC")
	iss.Equal(missingDates[2].ToTime().String(), "2021-03-18 18:40:01 +0000 UTC")
}
...
func TestSearch4(t *testing.T) {
	...
	iss := is.New(t)
	iss.Equal(len(missingDates), 3)
	iss.Equal(missingDates[0].ToTime().String(), "2021-04-03 18:40:00 +0000 UTC")
	iss.Equal(missingDates[1].ToTime().String(), "2021-04-04 18:40:00 +0000 UTC")
	iss.Equal(missingDates[2].ToTime().String(), "2021-04-05 18:40:00 +0000 UTC")
...
func TestSearch5(t *testing.T) {
	...
	iss.Equal(missingDates[0].ToTime().String(), "2021-04-05 18:40:00 +0000 UTC")
	iss.Equal(csvStyleDate, "2021-04-01 18:40:00")
}
